...
@section('header', app_term('create_new') . ' ' . app_term('article'))
        ...
        <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-6">
            ...
            <div class="space-y-2">
                ...
                <textarea name="excerpt" id="excerpt" rows="3" 
                          ...
                          placeholder="A short summary of the article for listings...">{{ old('excerpt') }}</textarea>
            ...
            <div x-show="expanded" x-cloak class="p-8 border-t border-slate-50 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="seo_description" id="seo_description" rows="3" 
                              class="w-full px-5 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none"
                              placeholder="Defaults to excerpt if empty">{{ old('seo_description') }}</textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="space-y-8">
        <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 space-y-6">
            ...
            <div class="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                ...
                <div x-data="{ checked: {{ old('is_featured') ? 'true' : 'false' }} }" class="relative inline-block w-12 mr-2 align-middle select-none transition duration-200 ease-in">
